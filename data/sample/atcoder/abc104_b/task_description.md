...
. Each character of 
S
 is uppercase or lowercase English letter.
Determine if 
S
...
If 
S
 satisfies all of the conditions in the problem statement, print 
AC
; otherwise, print 
WA
.
...
The second letter should not be 
C
.
...
There should not be two or more occurrences of 
C
.
